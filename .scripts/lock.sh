...
lock() {
        i3lock -n -c 00000066 -e --fill \
                ...
                --time-color=F6F3F3 --timeoutline-color=F6F3F3  --time-font="$CLOCK_FONT:style=Italic" --time-size=64 \
                --date-str="%A, %d %b %Y" \
                --date-pos="tx:ty+42"\
                --date-color=F6F3F3 --date-font="$FONT:style=Bold" --date-size=24 \
                --greeter-text="\"$quote\"" \
                --greeter-pos="w/2:h/2+18"\
                --greeter-color=38A0EE --greeter-font="$FONT" --greeter-size=24 \
